...
const ChampionChange = (props) => {
  ...
  const { champ } = props;
  return (
    <div className="champion-change">
      <div className="champion-change__header">
        <img
      ...
      {champ.changes.map((ability) => {
        ...
        return (
          <div className="champion-change__change">
            <div className="champion-change__change__name">
              {abilityIcon && <img src={abilityIcon} alt="ablt" />}
              <Typography variant="h4" component="h5">
                {temp[abilityKey].title}
              </Typography>
            </div>
            <div className="champion-change__change__block">
